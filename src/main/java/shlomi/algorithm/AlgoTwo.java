...
//
//        // End of the day
//        if ( dateTime.getTime().isAfter( TA35.getInstance().getEndOfIndexTrading().minusSeconds( 10 ) ) && positions.posStatus != Positions.CLOSE_END_OF_DAY ) {
//
//            if ( positions.posStatus == Positions.LONG ) {
//                positions.closeLong();
